...
public interface CgformEnhanceHttpInter {
    ...
    default Object sendPost(JSONObject params, OnlCgformEnhanceJava enhance) {
        ...
        ResponseEntity<String> request = RestUtil.request(cgJavaValue, HttpMethod.POST, getHeaders(((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest()), (JSONObject) null, params, String.class);
