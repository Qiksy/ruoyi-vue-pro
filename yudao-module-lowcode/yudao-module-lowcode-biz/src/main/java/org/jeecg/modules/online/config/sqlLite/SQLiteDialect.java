...
/* renamed from: org.jeecg.modules.online.config.a.a */
/* loaded from: hibernate-re-3.6.1-beta.jar:org/jeecg/modules/online/config/a/a.class */
public final class SQLiteDialect extends Dialect {
    public SQLiteDialect() {
        ...
        registerColumnType(1, ExtendJsonKey.TEXT);
        registerColumnType(12, ExtendJsonKey.TEXT);
        registerColumnType(2005, ExtendJsonKey.TEXT);
        registerColumnType(-1, ExtendJsonKey.TEXT);
        registerColumnType(2004, "blob");
        registerColumnType(2005, "clob");
        registerColumnType(91, OnlFormShowType.DATE);
