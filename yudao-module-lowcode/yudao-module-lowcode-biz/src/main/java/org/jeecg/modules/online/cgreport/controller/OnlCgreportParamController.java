...
public class OnlCgreportParamController {
    ...
    /* renamed from: a */
    public CommonResult<List<OnlCgreportParam> > m419a(@RequestParam("headId") String str) {
        ...
        CommonResult<List<OnlCgreportParam> > result = new CommonResult<>();
        return success(list);
    }
    ...
    /* renamed from: a */
    public CommonResult<IPage<OnlCgreportParam>> m420a(OnlCgreportParam onlCgreportParam,
                                                 @RequestParam(name = "pageNo", defaultValue = "1") Integer num,
                                                 @RequestParam(name = "pageSize", defaultValue = "10") Integer num2,
                                                 HttpServletRequest httpServletRequest) {
        CommonResult<IPage<OnlCgreportParam>> result = new CommonResult<>();
    ...
    /* renamed from: a */
    public CommonResult<?> m421a(@RequestBody OnlCgreportParam onlCgreportParam) {
    ...
    /* renamed from: b */
    public CommonResult<?> m422b(@RequestBody OnlCgreportParam onlCgreportParam) {
    ...
    /* renamed from: b */
    public CommonResult<?> m423b(@RequestParam(name = "id", required = true) String str) {
    ...
    /* renamed from: c */
    public CommonResult<?> m424c(@RequestParam(name = "ids", required = true) String str) {
    ...
    /* renamed from: d */
    public CommonResult<OnlCgreportParam> m425d(@RequestParam(name = "id", required = true) String str) {
        return success(this.onlCgreportParamService.getById(str));
    }
}
