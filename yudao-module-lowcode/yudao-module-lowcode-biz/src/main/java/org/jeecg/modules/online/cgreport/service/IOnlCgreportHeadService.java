...
public interface IOnlCgreportHeadService extends IService<OnlCgreportHead> {
    CommonResult<?> editAll(OnlCgreportModel onlCgreportModel);

    CommonResult<?> delete(String str);

    CommonResult<?> bathDelete(String[] strArr);
    ...
    List<String> getSqlFields(String str, String str2) throws Exception;
