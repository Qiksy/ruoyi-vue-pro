...
public class JSqlParserUtils {
     ...
     * @return
     */
    public static Map<String, SelectSqlInfo> parseAllSelectTable(String selectSql) throws Exception {
        if (ConvertUtils.isEmpty(selectSql)) {
            return null;
        }
     ...
     * @return
     */
    public static SelectSqlInfo parseSelectSqlInfo(String selectSql) throws Exception {
        if (ConvertUtils.isEmpty(selectSql)) {
            return null;
        }
        // log.info("解析查询Sql：{}", selectSql);
        ...
        if (stmt instanceof Select) {
            ...
            // 非 select 查询sql，不做处理
            throw new Exception("非 select 查询sql，不做处理");
        }
    }
     ...
     * @return
     */
    private static SelectSqlInfo parseBySelectBody(SelectBody selectBody) throws Exception {
        // 简单的select查询
        if (selectBody instanceof PlainSelect) {
            ...
            throw new Exception("暂时尚未处理该类型的 SelectBody");
        }
    }
     ...
     */
    private static void handleExpression(SelectSqlInfo sqlInfo, Expression expression, Alias alias) throws Exception {
     ...
     * @param sqlInfo
     */
    private static void handleFunctionExpression(Function functionExp, SelectSqlInfo sqlInfo) throws Exception {
