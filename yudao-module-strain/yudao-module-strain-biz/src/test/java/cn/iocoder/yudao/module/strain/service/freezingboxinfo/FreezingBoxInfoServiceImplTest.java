...
public class FreezingBoxInfoServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFreezingBoxInfoPage() {
       ...
       // 测试 code 不匹配
       freezingBoxInfoMapper.insert(cloneIgnoreId(dbFreezingBoxInfo, o -> o.setCode(null)));
       // 测试 name 不匹配
       freezingBoxInfoMapper.insert(cloneIgnoreId(dbFreezingBoxInfo, o -> o.setName(null)));
       // 测试 remark 不匹配
       freezingBoxInfoMapper.insert(cloneIgnoreId(dbFreezingBoxInfo, o -> o.setRemark(null)));
       // 准备参数
       ...
       assertPojoEquals(dbFreezingBoxInfo, pageResult.getList().get(0));
    }
    ...
    public void testGetFreezingBoxInfoList() {
       ...
       assertPojoEquals(dbFreezingBoxInfo, list.get(0));
    }
